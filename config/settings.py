...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='imad25imo@gmail.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='uxlg rfyz jith qrad')
DEFAULT_FROM_EMAIL = f'WorkManager <{config("EMAIL_HOST_USER", default="imad25imo@gmail.com")}>'